...
import { UnitedBlobForm } from "./_components/united_blob_form";
...
export default function Page() {
  ...
  const getRouter = () => {
    if (
      sourceType === $Enums.InsuranceScanSourceType.CIGNA_INDEX_API.toString()
    ) {
      return (
        <CignaIndexForm
          onChangeJson={(key, value) => {
    ...
    if (
      sourceType ===
      $Enums.InsuranceScanSourceType.UNITED_HEATHCARE_BLOB_API.toString()
    ) {
      return (
        <UnitedBlobForm
          onChangeJson={(key, value) => {
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectGroup>
                            ...
                            <SelectItem value="CIGNA_INDEX_API">
                              CIGNA_INDEX_API
                            </SelectItem>
                            <SelectItem value="UNITED_HEATHCARE_BLOB_API">
                              UNITED_HEATHCARE_BLOB_API
                            </SelectItem>
                            <SelectItem value="AETNA_BLOB_API">
                              AETNA_BLOB_API
                            </SelectItem>
                            <SelectItem value="KAISER_PERMANENTE_TXT_IN_NETWORK">
                              KAISER_PERMANENTE_TXT_IN_NETWORK
                            </SelectItem>
                            <SelectItem value="KAISER_PERMANENTE_TXT_OUT_OF_NETWORK">
                              KAISER_PERMANENTE_TXT_OUT_OF_NETWORK
                            </SelectItem>
                            <SelectLabel>Scrape</SelectLabel>
                            <SelectItem value="HCSC_SCRAPER">
                              HCSC_SCRAPER
                            </SelectItem>
                            <SelectItem value="CIGNA_SCRAPER">
                              CIGNA_SCRAPER
                            </SelectItem>
                            <SelectItem value="MOLINA_HEALTHCARE_SCRAPER">
                      ...
                      <FieldDescription>
                        Type of source to import data from see docs: TODO: Make
                        docs
                      </FieldDescription>
                      {fieldState.invalid && (
